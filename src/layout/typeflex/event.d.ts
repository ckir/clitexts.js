import { YGMeasureMode } from './enums.js';
...
export type EventData = NodeAllocationData | NodeDeallocationData | LayoutPassStartData | LayoutPassEndData | MeasureCallbackEndData | NodeLayoutData;
