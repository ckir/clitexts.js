...
// console.log(splitter.splitGraphemes("abcd")); // returns ["a", "b", "c", "d"]

// // two-char emojis and six-char combined emoji
// console.log(splitter.splitGraphemes("🌷🎁💩😜👍🏳️‍🌈")); // returns ["🌷","🎁","💩","😜","👍","🏳️‍🌈"]

// // diacritics as combining marks, 10 JavaScript chars
// console.log(splitter.splitGraphemes("Ĺo͂řȩm̅")); // returns ["Ĺ","o͂","ř","ȩ","m̅"]

// // individual Korean characters (Jamo), 4 JavaScript chars
// console.log(splitter.splitGraphemes("뎌쉐")); // returns ["뎌","쉐"]

// // Hindi text with combining marks, 8 JavaScript chars
// console.log(splitter.splitGraphemes("अनुच्छेद")); // returns ["अ","नु","च्","छे","द"]

// // demonic multiple combining marks, 75 JavaScript chars
// console.log(splitter.splitGraphemes("Z͑ͫ̓ͪ̂ͫ̽͏̴̙̤̞͉͚̯̞̠͍A̴̵̜̰͔ͫ͗͢L̠ͨͧͩ͘G̴̻͈͍͔̹̑͗̎̅͛́Ǫ̵̹̻̝̳͂̌̌͘!͖̬̰̙̗̿̋ͥͥ̂ͣ̐́́͜͞")); // returns ["Z͑ͫ̓ͪ̂ͫ̽͏̴̙̤̞͉͚̯̞̠͍","A̴̵̜̰͔ͫ͗͢","L̠ͨͧͩ͘","G̴̻͈͍͔̹̑͗̎̅͛́","Ǫ̵̹̻̝̳͂̌̌͘","!͖̬̰̙̗̿̋ͥͥ̂ͣ̐́́͜͞"]