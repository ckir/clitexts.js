...
import tinygradient from './TinyGradient.mjs';
...
for (const a in aliases) { // eslint-disable-line guard-for-in
    Object.defineProperty(InitGradient, a, {value: str => new InitGradient(aliases[a].colors)(str, aliases[a].options)})
	// exports[a] = str => new InitGradient(aliases[a].colors)(str, aliases[a].options);
    Object.defineProperty(InitGradient[a], 'multiline', {value: str => new InitGradient(aliases[a].colors).multiline(str, aliases[a].options)})
	// exports[a].multiline = str => new InitGradient(aliases[a].colors).multiline(str, aliases[a].options);
}
export default InitGradient;

// let duck = InitGradient('orange', 'yellow').multiline([
//     "  __",
//     "<(o )___",
//     " ( ._> /",
//     "  `---'",
